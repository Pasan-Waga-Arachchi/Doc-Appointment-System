...
namespace RAD_Project {
    ...
    public partial class LOGINDataSet : global::System.Data.DataSet {
        ...
        public partial class DoctorDataTable : global::System.Data.TypedTableBase<DoctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DoctorRow AddDoctorRow(string user_name, string password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DoctorRow FindBypassword(string password) {
...
namespace RAD_Project.LOGINDataSetTableAdapters {
    ...
    public partial class DoctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Doctor] WHERE (([user_name] = @Original_user_name) AND ([passw" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctor] ([user_name], [password]) VALUES (@user_name, @passwor" +
                "d);\r\nSELECT user_name, password FROM Doctor WHERE (password = @password)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Doctor] SET [user_name] = @user_name, [password] = @password WHERE " +
                "(([user_name] = @Original_user_name) AND ([password] = @Original_password));\r\nSE" +
                "LECT user_name, password FROM Doctor WHERE (password = @password)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_name, password FROM dbo.Doctor";
        ...
        public virtual int Fill(LOGINDataSet.DoctorDataTable dataTable) {
        ...
        public virtual LOGINDataSet.DoctorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LOGINDataSet.DoctorDataTable dataTable = new LOGINDataSet.DoctorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LOGINDataSet.DoctorDataTable dataTable) {
